...
class TestHomePage(EdgeDriverSetUp):
    ...
    def test_contact_btn(self):
        ...
        time.sleep(1)
        self.assertEqual(self.driver.find_element(By.XPATH, "/html/body/div[1]").get_attribute("class"),
                         "modal fade show")
    ...
    def test_login_btn(self):
        ...
        time.sleep(1)
        self.assertEqual(self.driver.find_element(By.XPATH, '//*[@id="logInModal"]').get_attribute("class"),
                         "modal fade show")
